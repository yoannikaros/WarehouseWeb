        ...
        <div class="row">
            <div class="col-md-4 offset-md-4 form">
                <form action="signup-user.php" method="POST" autocomplete="">
                    ...
                    <p class="text-center">Isi data-data berikut untuk melanjutkan.</p>
                    <?php
                    if(count($errors) == 1){
                        ?>
                    ...
                    <div class="form-group">
                        <input class="form-control" type="text" name="number" placeholder="Nomor Telepon" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="link login-link text-center">Sudah punya akun? <a href="login-user.php">Login disini</a></div>
                </form>
            </div>
        </div>
    </div>
